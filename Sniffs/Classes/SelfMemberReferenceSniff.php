 ...
 *  <li>DISABLED self:: is used for local static member reference</li>
 *  <li>self:: is used instead of self ::</li>
 * </ul>
 *
 * @category  PHP
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Snap_Sniffs_Classes_SelfMemberReferenceSniff extends PHP_CodeSniffer_Standards_AbstractScopeSniff
{
    ...
    protected function processTokenWithinScope(PHP_CodeSniffer_File $phpcsFile, $stackPtr, $currScope)
    {
        ...
        if ($tokens[$className]['code'] === T_SELF) {
            ...
            if ($declarationName === $tokens[$className]['content']) {
				...
				if (false && /* disabled */ $phpcsFile->hasCondition($stackPtr, T_CLOSURE) === false) {
