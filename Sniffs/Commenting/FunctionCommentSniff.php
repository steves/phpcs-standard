 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Snap_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if (empty($long) === false) {
            ...
            if ($newlineBetween > 2) {
                $error = 'There must be no more thank one blank line between descriptions in function comment';
        ...
        if (count($params) > 1) {
            ...
            if ($newlineSpan > 2) {
                $error = 'There must be no more than one blank line before the tags in function comment';
                if ($long !== '') {
